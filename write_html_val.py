...
ours_path = './exp_aachen24_batch_24/color/'
ours_epoch_1000_path = './val_aachen_24_batch_24_epoch_1000/color/'
ours_epoch_2000_path = './val_aachen_24_batch_24_epoch_2000/color/'
ours_epoch_3000_path = './val_aachen_24_batch_24_epoch_3000/color/'
ours_epoch_4000_path = './val_aachen_24_batch_24_epoch_4000/color/'
ours_epoch_5000_path = './val_aachen_24_batch_24_epoch_5000/color/'
...
file_path = './create_html_aachen24_val.txt'
f = open(file_path, 'w')
l = os.listdir(path)
s = ''
# for file in l:
